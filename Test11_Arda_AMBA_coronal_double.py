...
nt = Nutil(
    ...
    alignment_json="tests/test_data/Test10-17_Arda_synthetic_data/Test10-11_Arda_AMBA_coronal_nonlin_new.json",
    colour=[0, 0, 0],
...
nt.save_analysis("./test_result/Test11_Arda_AMBA_coronal_double")
