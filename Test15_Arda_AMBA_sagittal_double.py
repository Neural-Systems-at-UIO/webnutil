...
nt = Nutil(
    ...
    alignment_json="tests/test_data/Test10-17_Arda_synthetic_data/Test14-15_Arda_AMBA_sagittal_nonlin_new.json",
    colour=[0, 0, 0],
...
nt.save_analysis("./test_result/Test15_webnutil_AMBA_sagittal_double")
