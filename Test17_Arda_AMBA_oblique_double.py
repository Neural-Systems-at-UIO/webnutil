...
nt = Nutil(
    ...
    alignment_json="tests/test_data/Test10-17_Arda_synthetic_data/Test16-17_Arda_AMBA_oblique_nonlin_new.json",
    colour=[0, 0, 0],
...
nt.save_analysis("./test_result/Test17_Arda_AMBA_oblique_double")
