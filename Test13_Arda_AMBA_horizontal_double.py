...
nt = Nutil(
    ...
    alignment_json="tests/test_data/Test10-17_Arda_synthetic_data/Test12-13_Arda_AMBA_horizontal_nonlin_new.json",
    colour=[0, 0, 0],
...
nt.save_analysis("./test_result/Test13_webnutil_AMBA_horizontal_double")
